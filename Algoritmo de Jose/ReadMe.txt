========================================================================
    APLICACIÓN: Algoritmo de Jose Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Algoritmo de Jose.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Algoritmo de Jose.

Algoritmo de Jose.vcxproj
...
Algoritmo de Jose.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Algoritmo de Jose.pch y un archivo de tipos precompilados llamado StdAfx.obj.
